...
public class Student 
{
	...
	{
		Student student1 = new Student("divij", "mothe", "Sepetember16");
		System.out.println(student1.stuStat(student1));
		Student student2 = new Student("arun", "kumar", "March20");
		System.out.println(student2.stuStat(student2));
		Student student3 = new Student("anvesh", "rao","June10");
		System.out.println(student3.stuStat(student3));
		Student student4 = new Student("nischay", "reddy", "February2");
